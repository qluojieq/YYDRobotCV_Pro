 ...
 **/
public class RegisterCameraFragment1 extends Fragment implements SurfaceHolder.Callback ,Camera.PreviewCallback{

    private final String TAG = RegisterCameraFragment1.class.getSimpleName();
